...
版本 **0.5.24**。支持 Entropy、Lighter、Robinhood Lighter、QFEX、Decibel、Vanta、PopDEX、Arcus 的混合工具现已接入 pandazhai.com 管理中心。

## 0.5.24 权益刷新、语言与资源监控

权益独立补读与缓存、九种语言选择及顶部 CPU / 内存 / 磁盘占比。详见 [更新说明](RELEASE-0.5.24.md)。
...
配置按需展开、组合摘要与详情、常驻状态操作栏。详见 [更新说明](RELEASE-0.5.22.md)。

## 0.5.21 分平台默认手续费

Lighter / Robinhood Lighter 0、PopDEX / Vanta 3、Arcus 2、Entropy / QFEX 1 bps。详见 [更新说明](RELEASE-0.5.21.md)。
